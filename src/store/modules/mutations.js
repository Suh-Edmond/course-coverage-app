...
export const SET_SELECTED_COURSE = (state, selected_course) => {
  state.selectedCourse = selected_course
}
...
//set course delegate
 ...
 export const SET_NUMBER_COURSE_DELEGATE = (state, num_course_delegate) => {
  state.NumOfCourseDelegate = num_course_delegate;
 }
...
///set attend course
  export const SET_ATTEND_COURSE = (state, attend_course) =>{
    state.attendCourse = attend_course
  }
